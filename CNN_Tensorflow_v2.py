...
NUM_EXAMPLES = dataset_features_train_augmented.shape[0]
DIM_INPUT_FLAT = dataset_features_train_augmented.shape[1]
DIM_INPUT = [28, 28, 1]
DIM_OUTPUT = 10
NUM_EPOCHS = 20
BATCH_SIZE = 36
...
def convolutional_neural_network(input):
	...
	layer_1_output = tf.nn.dropout(layer_1_output, 0.5)
	...
	layer_2_output = tf.nn.dropout(layer_2_output, 0.5)
	...
	layer_3_output = tf.nn.dropout(layer_3_output, 0.5)
